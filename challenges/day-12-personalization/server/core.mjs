...
export function createInitialState() {
  ...
  return { revision: 0, activeProfile: 'novice', activeSession: sessionId, activeTask: taskId,
...
export function view(state, runtime = {}) {
  return { day: DAY, title: TITLE, revision: state.revision,
    ...
    activeProfile: state.activeProfile, profile: state.longTerm.profiles[state.activeProfile], profiles: Object.values(state.longTerm.profiles),
